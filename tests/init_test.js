(function () {
  ...
  casper.test.begin('Title page', 8, function (test) {
    return casper.start(url, function () {
      ...
      test.assertElementCount('.wrapper .esa-section a.button-shaped', 1, 'ESA link in view');
      test.assertElementCount('.wrapper .pip-section a.button-shaped', 1, 'ESA link in view');
